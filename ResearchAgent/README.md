...
```bash
venv/bin/python ResearchAgent/main.py schedule --run-immediately
```
...
```text
ResearchAgent/data/2026-03-01/manual-arxiv-glm-5-from-vibe-coding-to-agentic-engineering/
├── article.md
├── metadata.json
├── source.pdf
└── source.html
